...
```{r, eval=TRUE, include=TRUE, fig.height=6, fig.width=12, message=TRUE, warning=FALSE}
...
```{sql, eval=FALSE, include=TRUE, connection=conn, engine.opts="psql -d batiValizasDB", engine.path="/bin/postgres"}
